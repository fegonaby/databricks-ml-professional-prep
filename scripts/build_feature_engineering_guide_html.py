#!/usr/bin/env python3
"""Render the July 20-21 feature engineering and serving guide as HTML."""
...
MD_PATH = MARKDOWN_DIR / "feature-engineering-serving.md"
OUT_PATH = HTML_DIR / "feature-engineering-serving.html"
...
<header class="top"><div class="top-inner"><span class="brand">Feature Engineering Guide</span><input id="search" class="search" type="search" placeholder="Filter feature tables, point-in-time, online stores, serving, APIs, or traps" aria-label="Filter feature engineering guide"></div></header>
<div class="layout"><nav class="toc" aria-label="Contents"><h2>Contents</h2>{toc_html}</nav><main>
<div class="meta">Generated from <a href="../markdown/feature-engineering-serving.md">the Markdown source</a>. Verified July 23, 2026.</div>
