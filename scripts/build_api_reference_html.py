...
from render_math import render_math_block
...
def render_markdown(markdown):
    ...
    while index < len(lines):
        ...
        if stripped.startswith("```"):
            ...
            index += 1
            if language == "math":
                output.append(render_math_block(body))
            else:
                output.append(
